...
class Main {
    ...
    public static void main(String[] args) {
        ...
        //Create a gameEnded boolean and terminate the program when it is true
        boolean gameEnded = false;
        while(!gameEnded) {

            //Call a function to draw board
            drawBoard(board);
            ...
            //Create a char variable c that stores 'x' for player 1 and 'o' for player 2
            char c;
            if(player1) {
                c = 'x';
            } else {
    ...
    //Make a function to check if all the positions on the board have been filled
